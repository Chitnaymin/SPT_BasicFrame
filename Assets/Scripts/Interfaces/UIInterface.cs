...
public abstract class UIBase : MonoBehaviour
{
    ...
    {
        UpdateAllText();
        UpdateAllLocalizedImages();
        GLOBALFUNCTION.EvntLanguageChanged += UpdateAllText;
        GLOBALFUNCTION.EvntLanguageChanged += UpdateAllLocalizedImages;
    }
    ...
    protected virtual void UpdateAllLocalizedImages()
    {
